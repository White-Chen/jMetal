...
public class PointDimensionComparatorTest {
    ...
    @Test
    public void shouldCompareReturnZeroIfTheComparedValuesAreEqual() throws Exception {
        comparator = new PointDimensionComparator(0);
        assertEquals(0, comparator.compare(point1, point2));
    }

    @Test
    public void shouldCompareReturnMinusOneIfTheFirstValueIsLower() throws Exception {
        comparator = new PointDimensionComparator(0);
    ...
    @Test
    public void shouldCompareReturnPlusOneIfTheFirstValueIsGreater() throws Exception {
        comparator = new PointDimensionComparator(0);
