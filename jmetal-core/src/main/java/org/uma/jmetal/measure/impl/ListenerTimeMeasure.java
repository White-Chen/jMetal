...
public class ListenerTimeMeasure extends SimplePullMeasure<Long> implements
     ...
     * the unused wrappers).
     *
     * @param wrapped the {@link MeasureListener} to wrap
     ...
     * the unused wrappers).
     *
     * @param wrapped the {@link PushMeasure} to wrap
     ...
     *
     * @param wrapped    the {@link MeasureManager} to wrap
     * @param measureKey the key that the wrapper should use for this
