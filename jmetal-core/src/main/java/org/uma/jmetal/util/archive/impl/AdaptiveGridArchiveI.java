...
import org.uma.jmetal.util.grid.imp.AdaptiveGrid;
 ...
 */
public class AdaptiveGridArchiveI<S extends Solution<?>> extends AbstractBoundedArchive<S> {
     ...
     */
    public AdaptiveGridArchiveI(int maxSize, int bisections, int objectives) {
        super(maxSize);
